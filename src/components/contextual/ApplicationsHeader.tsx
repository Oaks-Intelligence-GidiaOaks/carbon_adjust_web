...
const ApplicationsHeader = () => {
  ...
  return (
    <div className="bg-[#F8FBFC] pl-6 pt-6 border-b border-[#DDD7D7] shadow-md">
      ...
      <div className="flex pb-10 pt-3">
          ...
          <div>
            ...
            >
              <img
                ...
                src={gridIcon}
                className={`w-4 ${
                  isAggregatorApplicationsTabActive ? "brightness-[1000%]" : ""
                }`}
              />{" "}
        ...
        <div className="w-[285px] -translate-x-[3%]">
          <button
            onClick={() => {
        ...
        <div className="w-[285px] -translate-x-[6%]">
          <button
            onClick={() => {
          ...
          >
            <div className="w-[100%] pointer-inner drop-shadow-sm">
              ...
              >
                ...
                >
                  <FinanceIcon
                    className={isFinanceTabActive ? "brightness-[1000%]" : ""}
                  />
                </div>
                <span
                  className={`font-poppins font-semibold ${
        ...
        <div className="w-[285px] -translate-x-[9%]">
          <button
          ...
          >
            <div className="w-[100%] pointer-inner drop-shadow-sm">
              ...
              >
                ...
                >
                  <InsuranceIcon
                    className={isInsuranceTabActive ? "brightness-[1000%]" : ""}
                  />
                </div>
                <span
                  className={`font-poppins font-semibold ${
          ...
          <div>
            ...
            >
              <img
                ...
                src={gridIcon}
                className={`w-4 ${
                  isInsuranceApplicationsTabActive ? "brightness-[1000%]" : ""
                }`}
              />{" "}
