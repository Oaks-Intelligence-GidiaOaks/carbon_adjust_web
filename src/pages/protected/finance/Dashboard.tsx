      ...
      {financeDashboardData.isSuccess && (
        <div className="w-full px-3">
          ...
          <div className="my-10">
            ...
            <StackedLineChart
              approved={
                financeDashboardData.data.data.data.applications_chart.approved
              }
              rejected={
                financeDashboardData.data.data.data.applications_chart.rejected
              }
              received={
                financeDashboardData.data.data.data.applications_chart.received
              }
            />
